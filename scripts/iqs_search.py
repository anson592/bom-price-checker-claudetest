#!/usr/bin/env python3
"""
阿里云 IQS 搜索脚本 - bom-price-checker 辅助数据源
支持两种接口：
...
def cross_verify(query: str, api_key: str, bocha_depth: str = "advanced",
    ...
    def run_bocha():
        ...
        try:
            sys.path.insert(0, os.path.expanduser("~/.workbuddy/skills/bom-price-checker/scripts"))
...
def main():
    parser = argparse.ArgumentParser(
        description="阿里云 IQS 搜索 - bom-price-checker 辅助查询",
